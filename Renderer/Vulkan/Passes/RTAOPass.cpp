...
void Render::Pass::RTAOPass::Setup(Graph::RenderGraphBuilder& builder)
{
...
void Render::Pass::RTAOPass::Execute(const RenderTypes::RenderContext& context, Render::Graph::RenderGraph& graph)
{
