...
namespace Render::Pass
{
    ...
    public:
            ...
            m_envMap(envMap), m_irrMap(irrMap), m_prefilterMap(prefiltermap), m_brdflut(brdflutmap), m_envTex(envTex), m_irrTex(irrTex), m_prefilterTex(prefilterTex), m_brdfTex(brdfTex)
        {
            ...
            m_LightingDescriptors = builder
                ...
                .addLayoutBinding(13, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT)
                .addLayoutBinding(14, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT)
    ...
    private:
        ...
        Graph::RGHandle m_ssaoMap;
        Graph::RGHandle m_rtAOGuided;
        Graph::RGHandle m_rtAOUnguided;

        Graph::RGHandle m_ssrOut;
        Graph::RGHandle m_rtReflectionGuided;
        Graph::RGHandle m_rtReflectionUnguided;
